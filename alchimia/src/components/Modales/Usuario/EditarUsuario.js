...
function getSteps() {
  return ["Datos Personales", "Foto Perfil"];
}
...
const options = ["Editar", "Ref. Personal", "Cerrar Sesión"];
            ...
            <>
              <div className={classes.rootRefPer}>
                <TextField
                  ...
                  placeholder="nombre de referencia : Ej:  Linkedin"
                  {...nomRef1}
                />
                <TextField
                  className={classes.rootRefPer}
                  required
                  id="standard-required"
                  label="Link Refrencia"
                  placeholder="link de referencia : Ej:  https://www.linkedin.com/in/xxxxx-xxxxx-12345678/"
                  {...linkRef1}
                />
              </div>
              <div className={classes.rootRefPer}>
