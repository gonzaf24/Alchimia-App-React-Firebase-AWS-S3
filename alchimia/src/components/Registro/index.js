...
export const Registro = ({ error, disabled, okMessage, onSubmit }) => {
  ...
  return (
    <>
      <Helmet>
        <title>Registrarse | Alchimia </title>
      ...
      <Container>
        <Div>
          ...
          <Form disabled={disabled} onSubmit={handleSubmit}>
            ...
            >
              <span fontSize="9px">
                Al registrarte, confirmas tu mayoría de
                <br />
                edad y aceptas las
                <a className="text-warning"> condiciones de uso </a>
                <br />y la
                <a className="text-warning">política de privacidad</a>.
              </span>
            </Typography>
            <br />
            {error && (
