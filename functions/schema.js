...
const firebaseConfig = {
  ...
  projectId: "alchimiaapi",
  storageBucket: "XXXXXXXXXXXXX.appspot.com",
  messagingSenderId: "XXXXXXXXXXXXXXX",
  appId: "XXXXXXXXXXXXXXXX:web:XXXXXXXXXXXXXXXXX",
};
    ...
    async follow(_, { input }, context) {
      ...
      try {
        ...
        if (userValidado.uid === userIdSeguidor) {
          const userSeguidor = await userModel.findById(userIdSeguidor);
          const userSeguido = await userModel.findById(userIdSeguido);
          var esSeguido = userSeguido.seguidores.includes(userIdSeguidor);
          if (esSeguido) {
